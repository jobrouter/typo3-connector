...
#. Line 23: Retrieve the :php:`Connection` entity class with handle `example`,
...
#. Lines 24-26: It can be the case that there is no connection entity available:
   There is no connection with handle `example` or the connection is disabled.
   So you have to consider this case.
#. Line 29: Create the REST client with the :php:`create()` method of the
